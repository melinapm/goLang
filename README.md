...
Se le asigna a la estructura Result el carácter o los caracteres correspondientes según la posición del array y 
se valida que cumplan  su respectiva condición (que sea de tipo texto, numero, longitud, etc). 
En caso que no se cumpla alguna de estas condiciones se torna un error, caso contrario se retorna la estructura result y un nil.
```
